...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\atom file\projects\medical_app\Backend\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\atom file\projects\medical_app\Backend\venv\Scripts\deactivate.nu'
